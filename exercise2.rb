...
You can use irb to test out your class by loading your class into the console using the load method (i.e. load 'cat.rb') and then creating 
...
class Cat
    ...
    def meow
        "My name is #{@name} and I eat at #{@meal_time}"
    end


end

joe = Cat.new("Joe", "cat food", 1)
jake = Cat.new("Jake", "chocolate", 3)
